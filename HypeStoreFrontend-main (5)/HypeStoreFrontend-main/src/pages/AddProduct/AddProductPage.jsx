    ...
    return (
      ...
      <div className='category'>
        ...
        <div className="multipart">
          <input id="fileInput" type="file" multiple onChange={fileChangeHandler} width={200} height={200}/>
        </div>
        <div className="inputfield">
            <input type="submit" value="Create Item" className="btn1" onClick={handleSubmit} href="/"></input>
        </div>
      </div>
    </div>
    );
